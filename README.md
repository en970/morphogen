...
**[Open the lab →](https://en970.github.io/morphogen)**  ·  **[Read the paper (PDF) →](paper/morphogen.pdf)**
...
models**](paper/morphogen.pdf) — the write-up, in the form it wants to be in: the
architecture, the measurements, the validation against the literature, and a
section on the things that did not work.
